...
<body>
    ...
    if (isset($_POST['newCust'])) {
        if (isset($_POST['New_customer'])) {
            ...
            if (!$result) {
                ...
                echo "<div id='alert' role='alert' class='alert alert-success'>Inserted Successfully
    ...
    if (isset($_GET['delete'])) {
        ...
        if (!$result) {
            ...
            echo "<div id='alert' role='alert' class='alert alert-success'>Deleted Successfully
                    <button type='button' data-bs-dismiss='alert' aria-label='Close' class='btn-close'>
                       ...
                       <?php
                            ...
                            ?>
                                ...
                                <tr class="<?php if($net>=0){echo'table-success';} else{echo 'table-danger';} ?>" >
                                    ...
                                    <td class="p-0" id="<?php echo $count; ?>" name="<?php echo $count; ?>"><?php echo $net ?></p>
                                    </td>
                                    <td id="<?php echo $count++; ?>" href="index1.php?edit=true&id=<?php echo $list['id']; ?>" name="edit">
                                    <button class="btn">
